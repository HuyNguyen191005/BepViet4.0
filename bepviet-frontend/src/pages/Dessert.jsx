...
const VegetarianPage = () => {
    ...
    useEffect(() => {
        ...
        axiosClient.get(`/categories/3/recipes?page=${currentPage}`)
            .then(res => {
    ...
    return (
        <div className="home-page">
            ...
            {/* 2. BANNER */}
            <div className="hero-section" style={{background: 'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("/images/vegetable-bg.jpg")', backgroundColor: '#fbbf24'}}>
                <h1 className="hero-title">{category?.name?.toUpperCase() || 'BÁNH NGỌT'} </h1>
