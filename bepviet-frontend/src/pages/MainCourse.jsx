...
const VegetarianPage = () => {
    ...
    return (
        <div className="home-page">
            ...
            {/* 2. BANNER */}
            <div className="hero-section" style={{background: 'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("/images/vegetable-bg.jpg")', backgroundColor: '#3b82f6'}}>
                <h1 className="hero-title">{category?.name?.toUpperCase() || 'ĐỒ UỐNG'} </h1>
